       ...
       if (chat.welcome) {
          ...
          for (let user of participants) {
            ...
            try {
              ...
              //let wel = `https://api-yogipw.herokuapp.com/api/welcome3?name=${encodeURIComponent(this.getName(user))}&mem=${encodeURIComponent(groupMetadata.participants.length)}&msg=SELAMAT%20DATANG%20DI%20GRUP%20${encodeURIComponent(this.getName(jid))}&picurl=${pp}&bgurl=https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRzOJUTDbRcqjR1ab1WFWTT1rhQFiJI47n_HA&usqp=CAU`
              let wel = await new Canvas.Welcome()
                     ...
                     .setAvatar(pp)
                     .setColor("border", "#ff0f0f")
                     .setColor("username-box", "#ff0f0f")
                     .setColor("discriminator-box", "#ff0f0f")
                     .setColor("message-box", "#ff0f0f")
                     .setColor("title", "#ff0f0f")
                     .setColor("avatar", "#ff0f0f")
